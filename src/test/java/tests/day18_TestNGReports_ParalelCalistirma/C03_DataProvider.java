...
public class C03_DataProvider {
    ...
    public void test01(String aranacakKelime){              // parametre ekledik.Şimdi ne aratılırsa onu getirecek!
        ...
        /*
        yapmaniz gereken tek sey : testinizi parametreli calisacak sekilde planlamak
